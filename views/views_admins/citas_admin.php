<?php
    ...
    try{
        $select_stmt = $mysqli_connection->prepare('SELECT c.*, l.usuario FROM citas c INNER JOIN users_login l ON c.idUser = l.idUser ORDER BY fecha_cita ASC');
...
<body>
    ...
    <main>
        ...
        <div class="container-fluid">
            <h2 class="my-4 text-center"> AGENDAR UNA CITA</h2>
            ...
            <div class="container d-flex flex-wrap justify-content-center">
                <form id="citas_form" name="citas_form" action="../../controllers/administradores/citas/c_add_citas.php" method="POST">
                    <ul class="p-0">
                        <li>
            ...
            <!-- GESTIÓN DE CITAS -->
            <div class="container-fluid">
                <h4 class="p-2 bg-success-subtle rounded text-center">GESTIÓN DE CITAS</h4>
                            ...
                            foreach ($citas as $citas){?>
                                <tr>
                                    ...
                                    <td class="text-end"><small class="liButton">
                                            <a href="./citas_admin_editar.php?idCita=<?php echo $citas['idCita']; ?>"><input type="submit" name="editar_cita" value="EDITAR"></a>
                                            <a href="../../controllers/administradores/citas/c_delete_citas.php?borrar_cita=<?php echo $citas['idCita']; ?>"><input type="submit" name="borrar_cita" value="BORRAR"></a>
                                        </small>
                                    </td>
                                </tr>
                        </tbody>
