...
function validar_registro($nombre, $apellido, $email, $telefono, $fecha_nac, $direccion, $pass, $checkboxPriv){
    ...
    # Validación del checkbox de la política de privacidad
    if(!$checkboxPriv){
        $errores['checkboxPriv'] = '- Debe aceptar la política de privacidad';
    }
