...
# Realizamos los registros de datos. Primero miramos si el método de envío que se está utilizando es POST y si el botón que se ha presionado para enviar el formulario es el correcto (registro)
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['registro'])){
    ...
    $checkboxPriv = isset($_POST['acepto']) ? true : false;
    

    # Validamos los datos del formulario a travéz de la función validar_registro
    $errores_validacion = validar_registro($nombre, $apellido, $email, $telefono, $fecha_nac, $direccion, $pass, $checkboxPriv);
            ...
            # SI el usuario NO existe
                ...
                # SI la sentencia se ha podido preparar
                    ...
                    if($insert_stmt -> execute()){
                        ...
                        $insert_login_stmt = $mysqli_connection -> prepare('INSERT INTO users_login (idUser, usuario, user_password) VALUES (?, ?, ?)');
                        ...
                        # SI la sentencia LOGIN se ha podido preparar
                            ...
                            $insert_login_stmt -> bind_param('iss', $idUser, $email, $hashed_password);
